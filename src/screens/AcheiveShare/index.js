      ...
      <div style={{textAlign: "center", fontSize: 20}}>
        ...
        <Button variant="contained" color="primary" onClick={()=>{
          ...
          window.liff.sendMessages([
            {
              "type": "image",
              "originalContentUrl": "https://admiring-mayer-fc6b08.netlify.com/img/30.jpg",
              "previewImageUrl": "https://admiring-mayer-fc6b08.netlify.com/img/30preview.jpg"
            }
          ]).then(sendText).catch(sendText)
