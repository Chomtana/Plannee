...
function find_catagories(text) {
	var data_name = ["อาหาร และ เครื่องดื่ม", "การเดินทาง", "เครื่องแต่งกาย และ เครื่องประดับ", "ข้าวของเครื่องใช้ในชีวิตประจำวัน", "ความบันเทิง", "เงินเดือน และ ค่าจ้าง", "เงินรางวัล", "อื่นๆ"];
	var data = [
		...
		["เงินเดือน", "ค่าจ้าง" , "ค่าทำ", "ค่านายหน้า"],
		["รางวัล", "ถูกหวย"]
	];
	...
	if (data_text.typeOfText === "เงินเดือน" || data_text.typeOfText === "ค่าจ้าง") {
		val_receive = 1;
	}
